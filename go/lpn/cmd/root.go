...
var RootCmd = &cobra.Command{
	...
	Long:  `A CLI tool for looking up phonenumber information.`,
}
...
func init() {
	...
	RootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.lpn.yaml)")
}
